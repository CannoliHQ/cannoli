...
data class CorePickerOption(val coreId: String, val displayName: String, val runnerLabel: String, val appPackage: String? = null, val raPackage: String? = null, val downloadable: Boolean = false)
