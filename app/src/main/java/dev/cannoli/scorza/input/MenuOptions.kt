...
internal const val MENU_ACHIEVEMENTS = "menu_achievements"
...
internal val MENU_LABELS: Map<String, Int> = mapOf(
    ...
    MENU_CHILD_COLLECTIONS to dev.cannoli.ui.R.string.title_child_collections,
    ...
    MENU_ACHIEVEMENTS to dev.cannoli.ui.R.string.label_achievements,
    ...
    MENU_DOWNLOAD_ART to dev.cannoli.ui.R.string.romm_settings_download_art,
    MENU_SAVE_SLOTS to dev.cannoli.ui.R.string.menu_save_slots,
    MENU_RESTORE_BACKUP to dev.cannoli.ui.R.string.save_backup_restore,
